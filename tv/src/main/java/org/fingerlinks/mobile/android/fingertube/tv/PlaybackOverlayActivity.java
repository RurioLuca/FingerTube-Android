...
public class PlaybackOverlayActivity extends Activity implements PlaybackOverlayFragment.OnPlayPauseClickedListener {
    ...
    public void onFragmentPlayPause(VideoModel movie, int position, Boolean playPause) {
        mVideoView.setVideoPath(movie.url);
    ...
    private void updatePlaybackState(int position) {
        PlaybackState.Builder stateBuilder = new PlaybackState.Builder().setActions(PlaybackState.ACTION_PAUSE | PlaybackState.ACTION_PLAY);
    ...
    private void updateMetadata(final VideoModel movie) {
        ...
        metadataBuilder.putString(MediaMetadata.METADATA_KEY_ARTIST, movie.title);
