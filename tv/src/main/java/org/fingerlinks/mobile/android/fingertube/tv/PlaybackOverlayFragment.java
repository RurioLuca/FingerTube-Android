...
public class PlaybackOverlayFragment extends android.support.v17.leanback.app.PlaybackOverlayFragment {
    ...
    private VideoModel mSelectedMovie;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mSelectedMovie = (VideoModel) getActivity().getIntent().getSerializableExtra("MOVIE");
    ...
    private int getDuration() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.ICE_CREAM_SANDWICH) {
            mmr.setDataSource(mSelectedMovie.url, new HashMap<String, String>());
        } else {
            mmr.setDataSource(mSelectedMovie.url);
        }
    ...
    private void updatePlaybackRow() {
        if (SHOW_IMAGE) {
            updateVideoImage(mSelectedMovie.image);
        }
    ...
    static class DescriptionPresenter extends AbstractDetailsDescriptionPresenter {
        ...
        protected void onBindDescription(ViewHolder viewHolder, Object item) {
            ...
            viewHolder.getSubtitle().setText(((VideoModel) item).title);
        }
    }
}
